...
{
    public partial class AddCPU_Colling : Form
    {
        ...
        {
            if (guna2TextBox1.Text != null && guna2TextBox2.Text != null && guna2TextBox3.Text != null)
            {
                ...
                {
                    sql.AddCPU_Cool(guna2TextBox1, guna2TextBox2, guna2TextBox3);
